...
gcloud dataproc jobs submit pyspark --region europe-west1 --cluster cluster-a35a gs://large_scale_data/pagerank-notype.py  -- gs://large_scale_data/small_page_links.nt 3
